...
$(document).ready(function(){
        ...
        if(location.pathname.search('/raves-reviews/') > -1){
            ...
            if(linkHref.search('/raves-reviews/') < 0  && linkHref !== '/#contact' && linkHref !== '/#links' && linkHref !== '/#raves-reviews'){
                ...
                function(){
                    ...
                    $(".youtube").colorbox({iframe:true, innerWidth:640, innerHeight:390, rel:'video', transition:"fade"});
                    $(".biographies").colorbox({rel:'biographies', top:"20px", transition:"fade", iframe:true, width:"90%", height:"80%"});
	...
	$('#fap').fullwidthAudioPlayer({autoPlay: true});
	$(".gallery-link").colorbox({rel:'group2', transition:"fade"});
	$(".youtube").colorbox({iframe:true, innerWidth:640, innerHeight:390, rel:'video', transition:"fade"});
	$(".raves-and-reviews-link").colorbox({rel:'group3', transition:"fade"});

	$(".3-pager").colorbox({rel:'3-pager', transition:"fade", top:"20px", width:"90%", height:"80%"});

	$(".biographies").colorbox({rel:'biographies', top:"20px", transition:"fade", iframe:true, width:"90%", height:"80%"});
	$(".lko-press-cbox").colorbox({rel:'lko-press', top:"20px", transition:"fade"});
